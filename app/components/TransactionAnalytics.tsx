...
const TransactionAnalytics = () => {
  ...
  return (
    <div className="backdrop-blur-xl bg-white/10 shadow-2xl rounded-lg p-6">
      <button
        onClick={analyzeTransactions}
        disabled={!publicKey || loading}
        className="w-full mb-6 py-3 rounded-xl font-mono bg-gradient-to-r from-solana-purple to-solana-green"
      >
